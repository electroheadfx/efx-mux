...
const { MODEL_ALIAS_MAP: CATALOG_MODEL_ALIAS_MAP, RUNTIME_PROFILE_MAP, KNOWN_RUNTIMES, RUNTIMES_WITH_REASONING_EFFORT } = require('./model-catalog.cjs');
const MODEL_ALIAS_MAP = {
  'opus': 'claude-opus-4-7',
  ...CATALOG_MODEL_ALIAS_MAP,
};
const {

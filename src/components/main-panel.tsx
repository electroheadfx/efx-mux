    ...
    <main class="main-panel relative" aria-label="Main panel">
      ...
      {fileViewerVisible.value && (
        <div class="absolute inset-0 flex flex-col" style={{ backgroundColor: colors.bgBase, zIndex: 10 }}>
          <div class="flex items-center justify-between px-4 py-3 shrink-0" style={{ backgroundColor: colors.bgElevated, borderBottom: `1px solid ${colors.bgBorder}` }}>
            <div class="flex items-center gap-3 min-w-0">
              <span class="text-[11px] px-2 py-0.5 rounded font-semibold tracking-wider shrink-0" style={{ backgroundColor: colors.accent, color: colors.bgBase }}>READ-ONLY</span>
            ...
            <button
              ...
              class="cursor-pointer px-4 py-2 rounded text-sm font-mono transition-colors duration-150 ml-4"

...
```bash
INIT=$(node "/Users/lmarques/Dev/efx-mux/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/lmarques/Dev/efx-mux/.codex/get-shit-done/templates/spec.md.

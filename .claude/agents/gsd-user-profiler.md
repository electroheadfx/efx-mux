...
<reference>
@/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/references/user-profiling.md` to load:

...
```bash
INIT=$(node "/Users/lmarques/Dev/efx-mux/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/lmarques/Dev/efx-mux/.codex/get-shit-done/bin/gsd-tools.cjs" commit \

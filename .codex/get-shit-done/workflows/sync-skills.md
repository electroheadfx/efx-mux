...
INSTALL_JS_GLOBAL="/Users/lmarques/Dev/efx-mux/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/lmarques/Dev/efx-mux/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.

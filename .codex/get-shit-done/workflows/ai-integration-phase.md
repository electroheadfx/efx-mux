...
<required_reading>
@/Users/lmarques/Dev/efx-mux/.codex/get-shit-done/references/ai-frameworks.md
@/Users/lmarques/Dev/efx-mux/.codex/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/lmarques/Dev/efx-mux/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/lmarques/Dev/efx-mux/.codex/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/lmarques/Dev/efx-mux/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/lmarques/Dev/efx-mux/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/lmarques/Dev/efx-mux/.codex/agents/gsd-eval-planner.md for instructions.

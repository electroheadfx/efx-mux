...
```bash
AUDITOR_MODEL=$(node "/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/lmarques/Dev/efx-mux/.claude/agents/gsd-eval-auditor.md for instructions.

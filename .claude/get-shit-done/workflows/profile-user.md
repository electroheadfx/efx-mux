...
```bash
cp "/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/USER-PROFILE.md" "/Users/lmarques/Dev/efx-mux/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/Users/lmarques/Dev/efx-mux/.claude/USER-PROFILE.backup.md"
```

...
<required_reading>
@/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/lmarques/Dev/efx-mux/.claude
                  → checks /Users/lmarques/Dev/efx-mux/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/lmarques/Dev/efx-mux/.claude/get-shit-done
                  → writes to /Users/lmarques/Dev/efx-mux/.claude/get-shit-done/hooks/
...
@/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```

...
```
Task(
  prompt="Read /Users/lmarques/Dev/efx-mux/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/lmarques/Dev/efx-mux/.codex/get-shit-done/templates/SECURITY.md`

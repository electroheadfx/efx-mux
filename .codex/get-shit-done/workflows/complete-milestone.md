...
```bash
node "/Users/lmarques/Dev/efx-mux/.codex/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/lmarques/Dev/efx-mux/.codex/get-shit-done/templates/retrospective.md`.

...
- **Global scope**: `/Users/lmarques/Dev/efx-mux/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/lmarques/Dev/efx-mux/.codex/notes/`)
...
2. Glob `/Users/lmarques/Dev/efx-mux/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/lmarques/Dev/efx-mux/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/lmarques/Dev/efx-mux/.codex/notes/` — works in any directory

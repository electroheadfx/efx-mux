...
<required_reading>
@/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/references/user-story-template.md
@/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/references/spidr-splitting.md
@/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/lmarques/Dev/efx-mux/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
